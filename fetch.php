...
foreach($result as $row)
{
 ...
 if($row["image"] != '')
 {
  $image = '<img src="upload/'.$row["image"].'" class="img img-thumbnail img-responsive" width="50" height="35" />';
 }
 else
 {
  $image = '';
 ...
 $sub_array[] = $row["last_name"];
  $sub_array[] = '<a class="text-primary" href="mailto:"'.$row["email"].'" ">'.$row["email"].'</a>';
